...
import { GameState, createInitialGameState, startGame, selectAnswer, confirmAnswer, useLifeline, setAudienceVoteResults, setChallengeNumber, acceptChallenge, rejectChallenge, toggleAudienceResults } from '@/lib/game-state';
